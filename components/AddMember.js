...
//   return (
//     <div className="p-4 sm:p-6 flex justify-center items-start overflow-auto h-screen pt-0">
//       <div className="w-full max-w-8xl mx-auto">
//         <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 sticky top-0 bg-gray-800 py-2 z-10 text-white dark:bg-gray-900 px-4 sm:px-0">
//           Add New Member
//         </h2>

//         <div className="bg-gray-800 p-4 sm:p-6 rounded-lg text-white h-[calc(100vh-10rem)] sm:h-[calc(100vh-12rem)] overflow-y-auto shadow-lg dark:bg-gray-900">
//           {error && (
//             <div className="bg-red-500 text-white p-3 sm:p-4 rounded mb-4 sm:mb-6">
//               <div className="flex items-center">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
//                   <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
//                 </svg>
...
//           {successMessage && (
//             <div className="bg-green-500 text-white p-3 sm:p-4 rounded mb-4 sm:mb-6">
//               <div className="flex items-center">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
//                   <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
//                 </svg>
...
//             {/* Profile Photo Upload */}
//             <div className="col-span-2 flex flex-col items-center mb-6 sm:mb-8">
//               <div 
//                 className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-gray-700 flex items-center justify-center mb-3 sm:mb-4 overflow-hidden cursor-pointer border-2 border-red-500 hover:border-red-400 shadow-lg transition-all duration-300 hover:shadow-red-500/20 group relative"
//                 onClick={() => fileInputRef.current.click()}
//               >
//                 {photoPreview ? (
//                   <>
...
//                 ) : (
//                   <div className="text-center p-4">
//                     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 sm:h-14 sm:w-14 text-gray-400 mx-auto group-hover:text-red-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
//                     </svg>
//                     <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2 font-light group-hover:text-white transition-colors duration-300">Add Profile Photo</p>
//                   </div>
//                 )}
//               </div>
//               <input 
...
//             {/* Personal Information */}
//             <h3 className="col-span-2 text-lg sm:text-xl font-semibold mb-2 text-red-500 border-b border-gray-700 pb-2">
//               Personal Information
//             </h3>
...
//                 value={formData.full_name}
//                 onChange={handleChange}
//                 className="bg-gray-700 p-2 text-sm sm:text-base rounded text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 w-full border border-gray-600"
//                 required
//               />
//             </div>
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Age *</label>
//               <input
//                 type="number"
//                 name="age"
//                 value={formData.age}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Gender *</label>
//               <select
//                 name="gender"
//                 value={formData.gender}
//                 onChange={handleChange}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Trainer Name </label>
//               <input
//                 type="text"
//                 name="trainer_name"
//                 value={formData.trainer_name}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Pincode *</label>
//               <input
//                 type="text"
//                 name="pincode"
//                 value={formData.pincode}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Emergency Contact *</label>
//               <input
//                 type="tel"
//                 name="emergency_contact"
//                 value={formData.emergency_contact}
...
//             {/* Membership Details */}
//             <h3 className="col-span-2 text-lg sm:text-xl font-semibold mb-2 text-red-500 mt-4 sm:mt-6 border-b border-gray-700 pb-2">
//               Membership Details
//             </h3>
            
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Membership Plan *</label>
//               <select
//                 name="membership_plan"
//                 value={formData.membership_plan}
//                 onChange={handleChange}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Amount Paid (₹) *</label>
//               <input
//                 type="number"
//                 name="amount_paid"
//                 value={formData.amount_paid}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Payment Status</label>
//               <select
//                 name="payment_status"
//                 value={formData.payment_status}
//                 onChange={handleChange}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Membership Status</label>
//               <select
//                 name="membership_status"
//                 value={formData.membership_status}
//                 onChange={handleChange}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Payment Date *</label>
//               <input
//                 type="date"
//                 name="payment_date"
//                 value={formData.payment_date}
...
//             <div className="space-y-1">
//               <label className="text-xs sm:text-sm text-gray-300">Renewal Date *</label>
//               <input
//                 type="date"
//                 name="renewal_date"
//                 value={formData.renewal_date}
...
//             {/* Form Actions */}
//             <div className="col-span-2 flex justify-end space-x-3 sm:space-x-4 mt-6 sm:mt-8 pt-4 border-t border-gray-700">
//               <button
//                 type="button"
//                 onClick={handleReset}
//                 className="px-4 py-1.5 sm:px-6 sm:py-2 rounded font-medium bg-gray-600 hover:bg-gray-500 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-sm sm:text-base"
//               >
//                 Reset Form
//               </button>
//               <button
//                 type="submit"
//                 disabled={isSubmitting}
//                 className="px-4 py-1.5 sm:px-6 sm:py-2 rounded font-medium bg-red-600 hover:bg-red-500 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-70 disabled:cursor-not-allowed flex items-center text-sm sm:text-base"
//               >
//                 {isSubmitting ? (
//                   <>
...
const AddMember = () => {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 flex justify-center items-start overflow-auto h-screen pt-0">
      <div className="w-full max-w-7xl mx-auto">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-4 md:mb-6 sticky top-0 bg-gray-800 py-2 z-10 text-white dark:bg-gray-900 px-2 sm:px-4 md:px-0">
          Add New Member
        </h2>

        <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg text-white h-[calc(100vh-8rem)] sm:h-[calc(100vh-10rem)] md:h-[calc(100vh-12rem)] overflow-y-auto shadow-lg dark:bg-gray-900">
          {error && (
            <div className="bg-red-500 text-white p-2 sm:p-3 md:p-4 rounded mb-3 sm:mb-4 md:mb-6">
              <div className="flex items-center">
          ...
          {successMessage && (
            <div className="bg-green-500 text-white p-2 sm:p-3 md:p-4 rounded mb-3 sm:mb-4 md:mb-6">
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            {/* Profile Photo Upload */}
            <div className="col-span-1 sm:col-span-2 flex flex-col items-center mb-4 sm:mb-6">
              <div 
                className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 rounded-full bg-gray-700 flex items-center justify-center mb-2 sm:mb-3 md:mb-4 overflow-hidden cursor-pointer border-2 border-red-500 hover:border-red-400 shadow-lg transition-all duration-300 hover:shadow-red-500/20 group relative"
                onClick={() => fileInputRef.current.click()}
              >
                {photoPreview ? (
                  <>
                  ...
                  <div className="text-center p-2 sm:p-3 md:p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10 md:h-14 md:w-14 text-gray-400 mx-auto group-hover:text-red-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2 font-light group-hover:text-white transition-colors duration-300">Add Photo</p>
                  </div>
                )}
              </div>
              <input 
            ...
            {/* Personal Information */}
            <h3 className="col-span-1 sm:col-span-2 text-base sm:text-lg md:text-xl font-semibold mb-1 sm:mb-2 text-red-500 border-b border-gray-700 pb-1 sm:pb-2">
              Personal Information
            </h3>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                value={formData.full_name}
                onChange={handleChange}
                className="bg-gray-700 p-1.5 sm:p-2 text-xs sm:text-sm md:text-base rounded text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 w-full border border-gray-600"
                required
              />
            </div>
            ...
            {/* Membership Details */}
            <h3 className="col-span-1 sm:col-span-2 text-base sm:text-lg md:text-xl font-semibold mb-1 sm:mb-2 text-red-500 mt-3 sm:mt-4 md:mt-6 border-b border-gray-700 pb-1 sm:pb-2">
              Membership Details
            </h3>
            ...
            {/* Form Actions */}
            <div className="col-span-1 sm:col-span-2 flex justify-end space-x-2 sm:space-x-3 md:space-x-4 mt-4 sm:mt-6 md:mt-8 pt-3 sm:pt-4 border-t border-gray-700">
              <button
                type="button"
                onClick={handleReset}
                className="px-2 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2 rounded font-medium bg-gray-600 hover:bg-gray-500 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-xs sm:text-sm md:text-base"
              >
                Reset Form
              </button>
              <button
                type="submit"
                disabled={isSubmitting}
                className="px-2 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2 rounded font-medium bg-red-600 hover:bg-red-500 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-70 disabled:cursor-not-allowed flex items-center text-xs sm:text-sm md:text-base"
              >
                {isSubmitting ? (
                  <>
